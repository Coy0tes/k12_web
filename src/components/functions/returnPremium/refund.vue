<template>
    ...
    <div class="title">
      <span style="margin-left:-76px;">费种转入</span>
    </div>
...
<div class="useKind">
   ...
   <el-button type="primary" class="search" @click="handleSearch" style="margin-left:2px;">查询</el-button>
  <br/>
...
<el-table :data="gridData">
  ...
  <span slot="footer" class="dialog-footer">
    ...
    <el-button class="tag_btn" type="primary" @click="dialogVisible = false">确 定</el-button>
     ...
     <div class="costKind">
      <span>转出费种:</span><el-select v-model="valued_"  type="input" placeholder="转出费种" class="costKind_input" @change="getId">
    <el-option
      ...
      <span >结&nbsp;&nbsp;余:</span>
      <el-input class="costKind_input" style="margin-left:-5px;" v-model="surplus"></el-input>
    ...
    <div class="costKind"> 
      <span>转入费种:</span><el-select v-model="value"  type="input" placeholder="转入费种" class="costKind_input" @change='get' >
    <el-option
...
// 
  ...
  // bug  options
              ...
              get(){
                 console.log('11111111111111111111',this.value);
              },
            getId(){
              console.log('11111111111111111111',this.gridData);
              console.log('11111111111111111111',this.valued_);
              console.log('11111111111111111111',this.redundOptions);
              for (var i = 0; i < this.gridData.length; i++) {
                  if(this.valued_==this.gridData[i].id){
                    this.surplus=this.gridData[i].money
                  }
              }
