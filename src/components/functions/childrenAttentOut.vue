              ...
              align='center'>
                ...
                <el-table-column
                  ...
                  <template slot-scope="scope" >
                    ...
                    <el-button @click="handleClick(scope.row)"  size="small"  v-if="scope.row.type">打卡</el-button>
          ...
          return Moment(date*1000).format("YYYY-MM-DD HH:mm ");  
            ...
            getData(){
                // time:true,
                 ...
                 this.$http({
                    method: 'get',
                    url: this.$getApi + 'api/attendances/findUnAttend?klassId='+this.value1+'&localDate='+ date_value,
