<template>
    ...
    <div style="width:100%;">
       <div style="width:102.5%;margin-left:-20px; padding-right:25px; padding-left:30px;margin-top:15px;" >
                     <div class="line1" style="margin-left:-20px;"> 
    ...
    <div style="margin-right:10px;margin-left:10px;padding-top:5px;">
