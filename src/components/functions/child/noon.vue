...
<!-- 正餐 -->
         ...
         <div>
            <p style="margin-bottom:20px;margin-left: -38px; font-size: 18px; font-weight: 700;">正餐</p>
        <el-radio-group v-model="radio3" style="margin-bottom:20px" @change="radio3Change">

            <el-radio :label="1">正常</el-radio>
            <el-radio :label="2">饭量少</el-radio>
            <el-radio :label="3">蔬菜少</el-radio>
            <el-radio :label="4">肉类少</el-radio>
            <el-radio :label="5">老师喂</el-radio>
            <!-- <el-radio :label="6">蚊虫叮咬</el-radio> -->
           ...
           <!-- 午睡 -->
        <div>
            <p style="margin-bottom:20px;margin-left: -38px; font-size: 18px; font-weight: 700;">午睡</p>
        <el-radio-group v-model="radio5" style="margin-bottom:20px" @change="radio5Change">

            <el-radio :label="1">正常</el-radio>
            <el-radio :label="2">少于30分中</el-radio>
            <el-radio :label="3">没睡</el-radio>
          </el-radio-group>
        </div>    
...
<!-- 选择儿童 -->
        <el-dialog
          ...
          :before-close="handleClose">
            ...
            <span style="display:inline-block;margin-left:150px"></span>班级：<el-select v-model="value" placeholder="请选择" style="width:250px;" @change="choesKlass">
                <el-option
    ...
    <!-- 提交检查 -->
            <el-dialog
              ...
              <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="dialogVisible = false" style="margin-right:0px;">全部发 布</el-button>
                                ...
                                <li class="bbb" :class="{'active':ind === index}" @click="chooce(index)">
                                    ...
                                    <div style="float:left;width:300px;height:100%;">
                                        <ul>
                                            ...
                                            <li style="width:140px;height:28px;background-color:#fff;margin-top:10px;margin-left:10px;float:left;padding-left:10px;line-height:26px">加餐：{{item.dinner|formatDinner}}</li>
                                         
                                           <li style="width:140px;height:28px;background-color:#fff;margin-top:10px;margin-left:10px;float:left;padding-left:10px;line-height:26px">午睡：{{item.afternap|formatAfterNap}} </li>
            ...
            <p style="margin-bottom:20px;margin-left: -38px; font-size: 18px; font-weight: 700;">备注</p>
                <el-input
                  ...
                  v-model="textarea">
                            ...
                            <el-button type="primary" @click="sureReplace " style="margin-left:116px;display:block;margin-top:30px;margin:0 auto;">确定</el-button>
                    </div>
        ...
        methods:{
            ...
            surePut(){
              this.loading2=true
                     ...
                     this.$getApi+'healthCheck/management/issue?ids='+ this.stuIds +'&type=NOON&klassId='+this.value,
                     {
            ...
            addData1(){
                var timestamp = Date.parse(new Date());
                 if (this.addDataArry.length==0) {
                    ...
                    this.$getApi+'healthCheck/management/addNoon?klassId='+this.value,
            ...
            radio3Change(){
                ...
                switch(num){
                    ...
                    this.radio3Value="WELL"
                        ...
                        break;
                    case 2:
                        this.radio3Value="LESSEATTING"
                        console.log("well",this.radio3Value)
                        break;
                    case 3:
                        this.radio3Value="LESSVEGETABLE"
                        console.log("well",this.radio3Value)
                        break; 
                    case 4:
            ...
            postCheck(){
              this.loading2=true
                     this.$http({
                    method: 'get',
                    url: this.$getApi + 'healthCheck/management/findPeriod?type=NOON&klassId='+this.value,
                    ...
                    console.log("===res getKlassData===",res);
                     var morningData=body.healthNoon
                    ...
                    // this.postCheckArry=body.healthMorning
                    this.postCheckArry=body.healthNoon
                    var chack=[]
                      res.body.forEach(function(item, index, array){
          ...
          // console.log(this)
            ...
            choesKlass(){
                console.log(this.value)
                 this.$http({
                    method: 'get',
                    url: this.$getApi + 'healthCheck/management/findUnChecked?klassId='+this.value+'&type=NOON',
