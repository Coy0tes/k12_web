<template>
    <div style="background-color:#fff;">
      <div class="title">
        ...
        <el-step title="填写银行账户"></el-step>
        <el-step title="选择签约产品"></el-step>
        <el-step title="填写经营信息"></el-step>
        <el-step title="确认签约信息"></el-step>
      </el-steps>
    ...
    <div style="margin-left:15%" v-show="contentFirst">
<!-- 企业信息 -->
        <div v-show="qiye">
          
        
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;"><span style="font-size:16px;font-weight:700;padding-left:10px;">企业信息 </span> 按照证书上内容逐字填写</div>
              <el-form style="margin-left:50px;" label-width="150px" :model="msgForm" ref="msgForm">
                    <el-form-item label="证件类型：" style="width:600px;" >
                        <el-radio v-model="radio" label="1">三证合一营业执照</el-radio>
                        <el-radio v-model="radio" label="2">普通营业执照</el-radio>
                    </el-form-item>

                    <el-form-item label="企业名称：" style="width:600px;" prop="companyName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '企业名称不能为空', trigger: 'blur' },

        
        ]">
                        <el-input v-model="msgForm.companyName"></el-input>
                     
                    </el-form-item> 

                    <el-form-item label="统一社会信用代码：" style="width:600px;" v-show="nomerY" prop="creditCode" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '统一社会信用代码不能为空', trigger: 'blur' },
        
        ]">
                        <el-input v-model="msgForm.creditCode"></el-input>
                     
                    </el-form-item>

                    <el-form-item label="注册号：" style="width:600px;" v-show="nomerN" prop="creditCode" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '注册号不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="单位所在地" style="width:600px;" prop="selectedOptions" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '注册号不能为空', trigger: 'blur' },
                      ...
                      <el-cascader
                          style="width:100%;"
                        :options="CityInfo"
                        v-model="msgForm.selectedOptions"
                        @change="handleChange">
                      </el-cascader>
                     <p style="color:rgb(206, 212, 230);">如果找不到所在城市，可选择所在地区或上级市</p>
                    </el-form-item>

                    <el-form-item label="住所：" style="width:600px;"  prop="homeAdd" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '住所不能为空', trigger: 'blur' },
        
        ]">
                        <el-input v-model="msgForm.homeAdd"></el-input>
                     
                    </el-form-item>
                    <el-form-item label="经营范围：" style="width:600px;" prop="ManagementRange" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '经营范围不能为空', trigger: 'blur' },
        
        ]">
                        <el-input type="textarea" v-model="msgForm.ManagementRange"></el-input>
                     
                    </el-form-item>
                    <el-form-item label="营业期限" style="width:600px;" >
                          <el-date-picker
                          v-model="value1"
                          type="date"
                          placeholder="选择日期">
                    ...
                    <el-form-item label="上传营业执照：" style="width:600px;" >
                      <span style="color:#ccc;">
                        仅支持中国大陆地区营业执照，且必须在有效期内<br>
                        格式要求：原件照、原件扫描件或复印件加盖公章的扫描件，<br>支持jpj,jpeg,
                        png,bmp格式文件，单个文件不超过5M。
                      </span>
                        <el-upload
                        ...
                        <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                            <img src="../../assets/u=2847801512,2793346854&fm=27&gp=0.jpg" height="150" width="150" alt="">
                            <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                              <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                            </span>
                        </span>
...
<!-- 社會團體 -->
     <div v-show="shehui">
            ...
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;"><span style="font-size:16px;font-weight:700;padding-left:10px;">社会团体信息 </span> 按照证书上内容逐字填写</div>
              <el-form style="margin-left:50px;" label-width="150px" :model="msgForm" ref="msgForm">
               

                    <el-form-item label="社会团体名称：" style="width:600px;" prop="companyName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '社会团体名称不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="社会信用代码：" style="width:600px;"  prop="creditCode":rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '社会信用代码不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="单位所在地" style="width:600px;" >
                      <el-cascader
                          style="width:100%;"
                        :options="CityInfo"
       ...
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '住所不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="业务范围：" style="width:600px;" prop="ManagementRange" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '业务范围不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="上传社会团体法人证书：" style="width:600px;" >
                      <span style="color:#ccc;">
                        仅支持中国大陆地区营业执照，且必须在有效期内<br>
                        格式要求：原件照、原件扫描件或复印件加盖公章的扫描件，<br>支持jpj,jpeg,
                        png,bmp格式文件，单个文件不超过5M。
                        ...
                        <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                            <img src="../../assets/shetuanti.png" height="150" width="150" alt="">
                            <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                              <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                            </span>
                        </span>
  ...
  <!-- 党机关 -->
      <div v-show="dangjiguan">
        
      
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;"><span style="font-size:16px;font-weight:700;padding-left:10px;">单位信息 </span> 按照证书上内容逐字填写</div>
              <el-form style="margin-left:50px;" label-width="250px" :model="msgForm" ref="msgForm">
               

                    <el-form-item label="单位名称：" style="width:600px;" prop="companyName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '单位名称不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="社会信用代码（或执法证号）：" style="width:600px;" prop="creditCode" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '社会信用代码（或执法证号）不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="单位所在地：" style="width:600px;" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '单位所在地不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="办公地址：" style="width:600px;" prop="homeAdd":rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '办公地址不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="执法职权：" style="width:600px;" prop="ManagementRange":rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '执法职权不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="上传行政执法资格照：" style="width:600px;" >
                      <span style="color:#ccc;">
                        仅支持中国大陆地区营业执照，且必须在有效期内<br>
                        格式要求：原件照、原件扫描件或复印件加盖公章的扫描件，<br>支持jpj,jpeg,
                        png,bmp格式文件，单个文件不超过5M。
                        ...
                        <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                            <img src="../../assets/dangjiguan.png" height="150" width="150" alt="">
                            <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                              <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                            </span>
                        </span>
...
<!-- 事业单位 -->
        <div v-show="shiye">
            ...
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;"><span style="font-size:16px;font-weight:700;padding-left:10px;">单位信息 </span> 按照证书上内容逐字填写</div>
              <el-form style="margin-left:50px;" label-width="250px" :model="msgForm" ref="msgForm">
                    ...
                    <el-form-item label="事业单位名称：" style="width:600px;" prop="companyName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '事业单位名称不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="社会信用代码（或事证号）：" style="width:600px;" prop="creditCode" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '社会信用代码（或事证号）不能为空', trigger: 'blur' },
       ...
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '单位所在地不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="住所：" style="width:600px;" prop="homeAdd" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '住所地址不能为空', trigger: 'blur' },
        
        ]">
                       <el-input v-model="msgForm.homeAdd"></el-input>
                     
                    </el-form-item>
                    <el-form-item label="宗旨和业务范围：" style="width:600px;" prop="ManagementRange" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '宗旨和业务范围不能为空', trigger: 'blur' },
                  ...
                  <el-input type="textarea" v-model="msgForm.ManagementRange"></el-input>                     
                    ...
                    <el-form-item label="上传事业单位法人证书：" style="width:600px;" >
                      <span style="color:#ccc;">
                        仅支持中国大陆地区营业执照，且必须在有效期内<br>
                        格式要求：原件照、原件扫描件或复印件加盖公章的扫描件，<br>支持jpj,jpeg,
                        png,bmp格式文件，单个文件不超过5M。
                        ...
                        <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                            <img src="../../assets/siyedanwei.png" height="150" width="150" alt="">
                            <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                              <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                            </span>
                        </span>
      ...
      <div v-show="minban">
             <div style="border-left:5px solid #409EFF;margin-bottom:25px;"><span style="font-size:16px;font-weight:700;padding-left:10px;">单位信息 </span> 按照证书上内容逐字填写</div>
              <el-form style="margin-left:50px;" label-width="250px" :model="msgForm" ref="msgForm">
                    ...
                    <el-form-item label="民办非企业名称：" style="width:600px;" prop="companyName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '企业名称不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="社会信用代码（或民政字号）：" style="width:600px;" prop="creditCode" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '社会信用代码（或民政字号）不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="单位所在地：" style="width:600px;" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '单位所在地止不能为空', trigger: 'blur' },
       ...
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '业务范围不能为空', trigger: 'blur' },
                    ...
                    <el-form-item label="上传民办非企业单位证书：" style="width:600px;" >
                      <span style="color:#ccc;">
                        仅支持中国大陆地区营业执照，且必须在有效期内<br>
                        格式要求：原件照、原件扫描件或复印件加盖公章的扫描件，<br>支持jpj,jpeg,
                        png,bmp格式文件，单个文件不超过5M。
                        ...
                        <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                            <img src="../../assets/minbanfeiqiye.png" height="150" width="150" alt="">
                            <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                              <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                            </span>
                        </span>
...
<!-- 法定代表人/代理人信息 -->
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;" ><span style="font-size:16px;font-weight:700;padding-left:10px;">法定代表人/代理人信息 </span></div>
                                            
                    <!-- 我是法定代表人                    -->
                                        <el-tabs v-model="activeName" style="width:650px;">
                                          <el-tab-pane label="我是法定代表人" name="first"style="padding-top:20px;">

                                        <el-form style="margin-left:50px;" label-width="150px" :model="legalPersonFrom" ref="legalPersonFrom">
                                                 <el-form-item label="法定代表人归属地：" style="width:600px;" prop="legalPersonAdd" :rules="[
                                                       { validator: validateMobile, trigger: 'blur' },
                                                        { required: true, message: '法定代表人归属地止不能为空', trigger: 'blur' },
                                                        
                                                        ]">
                                              
                                                          <el-input v-model="legalPersonFrom.legalPersonAdd"></el-input>
                                         
                                                </el-form-item>
                                                <el-form-item label="法定代表人姓名：" style="width:600px;" prop="legalPersonName" :rules="[
                                                 { validator: validateMobile, trigger: 'blur' },
                                                  { required: true, message: '法定代表人姓名不能为空', trigger: 'blur' },
                                                  
                                                  ]">
                                              
                                                          <el-input v-model="legalPersonFrom.legalPersonName"></el-input>
                                         
                                                </el-form-item>
                                                <el-form-item label="身份证类型：" style="width:600px;" >
                                              
                                                          <el-radio v-model="radio1" label="1">二代身份证</el-radio>
                                                          <el-radio v-model="radio1" label="2">临时身份证</el-radio>
                                         
                                                </el-form-item>
                                                <el-form-item label="身份证号：" style="width:600px;" prop="legalPersonID" :rules="[
                                                   { validator: validateMobile, trigger: 'blur' },
                                                    { required: true, message: '身份证号不能为空', trigger: 'blur' },
                                                     { pattern: /(^\d{15}$)|(^\d{18}$)|(^\d{17}(\d|X|x)$)/, message: '请输入正确的中国居民身份证号' }
                                                    
                                                    ]">
                                              
                                                          <el-input v-model="legalPersonFrom.legalPersonID"></el-input>
                                         
                                                </el-form-item>

                                                <el-form-item label="证件有效期：" style="width:600px;" >
                                                ...
                                                <el-form-item label="上传法人身份证" style="width:600px;" >
                                                        ...
                                                        <span>
                                                          ...
                                                          <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                                                              <img src="../../assets/身份证正.jpg" height="150" width="150" alt="">
                                                              <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                                                                <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                                                              </span>
                                                          </span>
                                                        ...
                                                        <span>
                                                          ...
                                                          <span style="display:inline-block;width:150px;height:150px;border:1px solid #ccc;">
                                                              <img src="../../assets/身份证反.jpg" height="150" width="150" alt="">
                                                              <span style="display:inline-block;width:150px;height:40px;background-color:rgba(0,0,0,.3); z-index:100;position: relative;top: -58px;">
                                                                <p style="text-align:center;font-size:16px;color:#fff;">示例</p>
                                                              </span>
                                                          </span>
...
<!-- 我是代理人 -->
      <el-tab-pane label="我是代理人" name="second" style="padding-top:20px;">

                                                  
                                        <el-form style="margin-left:50px;" label-width="150px" :model="legalPersonFrom" ref="legalPersonFrom">
                                                 <el-form-item label="代理人归属地：" style="width:600px;" prop="legalPersonAdd" :rules="[
                                                           { validator: validateMobile, trigger: 'blur' },
                                                            { required: true, message: '代理人归属地不能为空', trigger: 'blur' },
                                                ...
                                                <el-form-item label="代理人姓名：" style="width:600px;" prop="legalPersonName" :rules="[
                                                             { validator: validateMobile, trigger: 'blur' },
                                                ...
                                                <el-form-item label="上传代理人身份证" style="width:600px;">
                                                ...
                                                <el-form-item label="企业委托书扫描件" style="width:600px;" >
                                                  <span style="font-size:10px;color:#ccc;">委托书（必须盖有公司公章或财务专用章）</span>
                                                  <br>
                                                      <el-upload
                                                            action="https://jsonplaceholder.typicode.com/posts/"
                                                            list-type="picture-card"
          ...
          <div class="" v-show="contentSecond">
            
              <el-form style="margin-left:50px;" label-width="150px" :model="accountBankForm" ref="accountBankForm">
                  <el-form-item label="银行开戶名:" style="width:600px;" >
              
                      <span style="color:#e6a23c;font-size:14px">{{}}</span>
                      <br>
                      <span style="font-size:12px;color:#ccc;">请填写以<span style="color:#000;font-size:14px">{{}}</span>为开户名的对公银行账号。
                            资料审核完成后，支付宝会向此账户汇入一笔确认资金，若公司名称和账户开户姓名不一致会导致汇款失败。
                      </span>                 
                  </el-form-item>


                  <el-form-item label="开户银行:" style="width:600px;" prop="accountBankName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '开户银行不能为空', trigger: 'blur' },
        
        ]">
                    <el-input v-model="accountBankForm.accountBankName"></el-input>
                  </el-form-item>

                  <el-form-item label="企业对公账号:" style="width:600px;" prop="accountBankNum" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '企业对公账号不能为空', trigger: 'blur' },
        { pattern:/^([1-9]{1})(\d{14}|\d{18})$/, message: '请输入正确的银行账号' }
        
        ]">

                    <el-input v-model="accountBankForm.accountBankNum"></el-input>
                  </el-form-item>
          ...
          <!-- 选择签约 -->
          <div class="" v-show="contentThrid">
            <div style="margin-left:150px;width:800px;">
              <p style="font-size:18px;">我的应用</p>
              

                 <div style="width:100%;border:1px solid #ccc;margin-top:30px;padding-top:15px;padding-left:20px;padding-bottom:20px;"><!-- 高要去掉 -->
                  
                    
                     
                          <span class="el-dropdown-link" style="padding-bottom:20px;">
                            青幼通<i class="el-icon-arrow-down el-icon--right" @click="QYTshow"></i>
                          </span>
                          <div v-show="QYTshow11" style="margin-top:10px;">

                           
                             <el-checkbox v-model="checked">快捷手机wap支付</el-checkbox> <span style="display:inline-block;float:right;font-size:14px; margin-right:50px;">未签约</span>
                            <br>
                            <el-checkbox v-model="checked">中小学教育缴费</el-checkbox><span style="display:inline-block;float:right;font-size:14px; margin-right:50px;">未签约</span>
                            <br>
                            <el-checkbox v-model="checked">快捷手机安全支付</el-checkbox><span style="display:inline-block;float:right;font-size:14px; margin-right:50px;">未签约</span>
                          </div>
          ...
          <div class="" v-show="contentFourth" style="padding-left:150px;">
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;" ><span style="font-size:16px;font-weight:700;padding-left:10px;">经营信息 </span> <span style="font-size:14px;color:#ccc;">根据监管要求，请如实填写企业的经营信息。</span></div>
                  <el-form style="margin-left:50px;" label-width="150px"  :model="managerListForm" ref="managerListForm">
                      <el-form-item label="经营类目:" style="width:600px;" prop="managerList" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '经营类目不能为空', trigger: 'blur' },
        
        ]">
                            <el-input v-model="managerList"></el-input>
                                         
                      </el-form-item>

                      <el-form-item label="上传经营资质:" style="width:600px;" >
                        <span style="font-size:12px;color:#e6a23c;">请提供《民办学校办学许可证》或《事业单位法人证书》</span><span style="font-size:14px; color:#409eff;cursor: pointer" @click="dialogVisible=true">了解资质要求</span>
                             <el-upload
                                                            action="https://jsonplaceholder.typicode.com/posts/"
                                                            list-type="picture-card"
                                                            style="display:inline"
            ...
            <div style="border-left:5px solid #409EFF;margin-bottom:25px;" ><span style="font-size:16px;font-weight:700;padding-left:10px;">联系人信息 </span> <span style="font-size:14px;color:#e6a23c;">联系人信息将用于签约后的重要通知，</span><span style="font-size:14px;color:#ccc;">如确认协议、到期提醒等。</span></div>
                           <el-form style="margin-left:50px;" label-width="150px" :model="contactsFrom" ref="contactsFrom">
                      <el-form-item label="姓名:" style="width:600px;" prop="contactsName" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '联系人姓名不能为空', trigger: 'blur' },
        
        ]">
                            <el-input v-model="contactsFrom.contactsName"></el-input>
                                         
                      </el-form-item>

                      <el-form-item label="电子邮箱:" style="width:600px;"prop="contactsEmali" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '联系人电子邮箱不能为空', trigger: 'blur' },
        { pattern:/^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\.[a-zA-Z0-9_-]+)+$/, message: '请输入正确的邮箱账号' }
        ]">
                   
                                     <el-input v-model="contactsFrom.contactsEmali"></el-input>    
                      </el-form-item>
                         <el-form-item label="手机号码:" style="width:600px;" prop="contactsPhone" :rules="[
       { validator: validateMobile, trigger: 'blur' },
        { required: true, message: '联系人手机号码不能为空', trigger: 'blur' },
        { pattern:/^((1[3,5,8][0-9])|(14[5,7])|(17[0,6,7,8])|(19[7]))\d{8}$/, message: '请输入正确的手机号' }
        ]" >
                            <el-input v-model="contactsFrom.contactsPhone"></el-input>
             ...
             <span class="top_text">资质要求</span>
             <img src="../../assets/close3.png" height="48" width="48" class="add_close"@click="dialogVisible = false">
          </div>
                        <span><img src="../../assets/zizhiyaoqiu.jpg" height="" width="100%" alt=""></span>
          ...
          <div class="" v-show="contentFifth">
            <div style="margin-left:150px;">
                <span style="padding-bottom:30px">确认信息填写无误后点击下方签约按钮，申请签约。</span>
                <br>
                <el-button style="margin-top:30px">申请签约</el-button>
        ...
        <el-button style="margin-top: 12px;float:right;margin-right:10%;margin-bottom:50px;" @click="next('msgForm')"type="primary">下一步</el-button>
        <el-button style="margin-top: 12px;float:right;margin-right:10%;margin-bottom:50px;" @click="nav"type="primary" v-show="navShow" >上一步</el-button>
  
    </div>
</template>

<script>
import city from '../../assets/CivilMilitaryIntegration/city-data.js'
    export default {
        data(){
            return {
              msgForm:{      //公司信息
                ...
                businessEndTime:'',//营业期限 
              },
              legalPersonFrom:{//法人代理人信息
                legalPersonAdd:'',  //法人地址
                legalPersonName:'',//法人姓名
                legalPersonID:'',//法人身份证
                legalPersonIDTime:'',//法人身份证到期时间
        ...
        methods:{
          getData(){
            let cityData=city.CityInfo
            this.cityNumData=cityData
            console.log(cityData)


             var unitId = this.$store.state.unitid
             this.unitId=unitId
             if (unitId.id==1) {
                  this.qiye=true
                  this.shehui=false
                  this.dangjiguan=false
                  this.shiye=false
                  this.minban=false
             ...
             console.log('unitIdunitId',unitId.id)
          },
              next(formName) {
          ...
          if (valid) {
            ...
            return ;
              ...
              console.log('1111',this.selectedOptions)
      ...
      showOrNotshow(){
        if (this.active==0) {
               ...
               this.contentSecond=false
               this.contentThrid=false
               this.contentFourth=false
               this.contentFifth=false

        }else if (this.active==1) {
               this.contentFirst=false
               this.contentSecond=true
               this.contentThrid=false
               this.contentFourth=false
               this.contentFifth=false
