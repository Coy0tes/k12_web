...
-->
        ...
        <el-dialog title="添加课程" :visible.sync="dialogVisible" :before-close="handleClose(dialogVisible)" class="dialogSzie">
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                this.$http({
                    method: 'get',
                    url: 'http://k12soft.vwico.com:8080/management/courses',
                    // params: {
                    //     "description": "test",
                    //     "name": "xuliang"
                    // },
            ...
            isAdd(tag) { // 0 添加    1 取消
                ...
                if (tag === 0 && this.dialogUsage == 0) {
                   this.$http.post(
                    ...
                    'https://k12soft.vwico.com/management/courses',
                    {
                    ...
                    // const {body} = res;
                    console.log("===body=add==courses====",res);
                    this.getData();
                })
